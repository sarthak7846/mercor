...
import { ArrowRight, Award, Bot, CheckCircle2, Loader2, Sparkles, User } from "lucide-react";
          ...
          <section className="rounded-xl border border-border bg-card/60 p-6 backdrop-blur">
            ...
            <ul className="space-y-3">
              {result.improvements.map((imp, index) => (
                ...
                >
                  <ArrowRight className="mt-0.5 size-4 shrink-0 text-violet-400" />
                  <span className="text-sm leading-6">{imp}</span>
                </li>
              ))}
            </ul>
          </section>
          ...
          <section className="rounded-xl border border-border bg-card/60 p-6 backdrop-blur">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Areas where you performed particularly well during the
                  interview.
                </p>
              </div>
            </div>
            ...
            <ul className="space-y-3">
              {result.strengths.map((strength, index) => (
                ...
                >
                  ...
                  <span className="text-sm leading-6">{strength}</span>
                </li>
              ))}
            </ul>
          </section>
